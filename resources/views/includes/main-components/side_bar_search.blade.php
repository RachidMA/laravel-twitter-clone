<div class="h-100 border border-primary rounded  ">
    <div class="search h-75  mb-2 ">
        <form action="" class="d-flex h-50 justify-content-center align-items-center flex-column m-2 border border-secondary rounded" method="get ">
            <input type="text" name="search" placeholder="Search..." class="m-2 w-90 border border-primary rounded" />
            <button type="submit" name="Submit" class="w-50 m-2 btn btn-primary">Search</button>
        </form>
    </div>
