...
Route::middleware(['auth', 'member'])
    ->group(function () {
        ...
        Route::get('profiles/{profile}/edit', [ProfileController::class, 'edit'])->name('profiles.profile.edit')->middleware('can:edit,profile');
        Route::post('profiles/{profile}/store', [ProfileController::class, 'update'])->name('profiles.profile.store')->middleware('can:update,profile');
